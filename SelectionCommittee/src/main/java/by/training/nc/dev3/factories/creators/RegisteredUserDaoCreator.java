 ...
 */
public class RegisteredUserDaoCreator implements DaoCreator {

    public BaseDao create(BoneCP pool){
        try {
            return new RegisteredUserDaoImpl(pool.getConnection());
        }
        catch (SQLException e){
            throw new DaoUncheckedException("Registered user dao creator error");
        }
    }
}
